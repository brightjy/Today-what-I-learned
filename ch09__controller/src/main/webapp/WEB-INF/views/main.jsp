...
<body>
	...
	<h2><a href="${conPath }/board/view">board의 view로 가기</a></h2> 
	<h2><a href="${conPath }/board/content">board의 content로 가기</a></h2>
	<h2><a href="${conPath }/board/write">board의 write로 가기</a></h2>
