...
<form action="write.do" method="post" name="frm">
	<table>
		...
		<tr><th>사번</th>
			...
			<tr><th>입사일</th><td><input type="date" name="tempHiredate" required="required" style="width:200px;"></td></tr>
			<tr><th>급여</th><td><input type="number" name="sal" required="required" style="width:200px;"></td></tr>
			<tr><th>상여</th><td><input type="number" name="comm" required="required" style="width:200px;"></td></tr>
			<tr><th>부서코드</th>
